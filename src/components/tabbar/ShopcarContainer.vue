				...
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						...
						<div class="info">
							...
							<!-- 问题:如何从购物车中获取商品的数量呢 -->
						<!-- 	1.先创建一个空对象，然后循环购物车中所有商品的数据,
							把当前循环这条商品Id,作为对象的属性名，count值作为对象的属性值，这样，
							当把所有的商品循环遍历一遍,就会得到一个对象：{88：2，89：1，90：4} -->
...
<script>
	...
	export default{
		...
		methods:{
			...
			remove(id,index){
				// 点击删除，把商品从store中根据 传递的id删除，
				// 同时 把当前组件中的goodlist中对应要删除的那个商品，使用index来删除
